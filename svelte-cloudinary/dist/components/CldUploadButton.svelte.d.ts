...
declare const __propDef: {
    props: {
        onError?: ((error: {
            status: string;
            statusText: string;
        } | null, widget?: import("./CldUploadWidgetTypes.ts").UploadWidget | undefined) => void) | undefined;
        onUpload?: ((result: import("./CldUploadWidgetTypes.ts").ResultsEvents, widget?: import("./CldUploadWidgetTypes.ts").UploadWidget | undefined) => void) | undefined;
        options?: import("./CldUploadWidgetTypes.ts").CldUploadWidgetPropsOptions | undefined;
        onOpen?: ((widget?: import("./CldUploadWidgetTypes.ts").UploadWidget | undefined) => void) | undefined;
        onClose?: ((widget?: import("./CldUploadWidgetTypes.ts").UploadWidget | undefined) => void) | undefined;
        uploadPreset?: string | undefined;
        signatureEndpoint?: string | undefined;
...
export type CldUploadButtonProps = typeof __propDef.props;
export type CldUploadButtonEvents = typeof __propDef.events;
export type CldUploadButtonSlots = typeof __propDef.slots;
export default class CldUploadButton extends SvelteComponentTyped<CldUploadButtonProps, CldUploadButtonEvents, CldUploadButtonSlots> {
}
export {};
