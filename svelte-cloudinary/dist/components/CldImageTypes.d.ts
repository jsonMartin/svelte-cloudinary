...
type BaseProps = ImageOptions & ImageProps & {
...
* ```
**/
export type CldImageProps = Omit<BaseProps, 'width' | 'height'> & (Omit<FullWidthImageProps<HTMLImgAttributes, string | null>, 'height'> & {
