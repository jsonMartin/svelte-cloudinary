...
export type CldImageProps = typeof __propDef.props;
export type CldImageEvents = typeof __propDef.events;
export type CldImageSlots = typeof __propDef.slots;
export default class CldImage extends SvelteComponentTyped<CldImageProps, CldImageEvents, CldImageSlots> {
}
export {};
